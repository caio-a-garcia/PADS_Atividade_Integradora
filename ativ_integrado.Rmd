...
```
O erro da previsão do treinamento é de 33.32%.
...
resultados_floresta %>% 
  arrange(erro)
```
Conforme observado na tabela acima, a combinação que diminui o erro do modelo é com mtry = 4 e o n_arvores = 450.
